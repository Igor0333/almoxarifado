...
if ($sql_lote->rowCount() === 0){
	echo "<br><form action='testerecebe.php' method='post'><table>
	...
	<tr><td>Quantidade da O.F.:</td><td><input type='number' style='font-size: 10pt; height: 16px; width:180px;' name='qtde_of' value='$row[QTDEOF]' id='qtde_of' min='0' step='.01'/></td></tr>
...
<form name="formlote" action="testerecebe.php" method="post">
<table>
<tr>
<td>Lote:</td>
