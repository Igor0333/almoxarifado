...
<?php
	...
	echo "CADASTRO DE PRODUTOS - R J C DEFESA AEROESPACIAL LTDA
...
<?php
	...
	GROUP BY A.CODIGO,A.GRUPO,A.UNID,C.DESCRICAO,A.DESCRICAO,A.QUANT,B.SOMAOP,A.TIPINV,A.CLAFIS
...
try{
	...
	($linha = $sql->fetch(PDO::FETCH_ASSOC)){
		...
		echo "<tr>
				<td><a href='../../almoxarifado/requisicao/movimento.php?id=$linha[PROD]'>$linha[PROD]</a></td>
