...
<?php
	...
	echo "Olá!!<br><br> Dados da ORDEM DE FABRICAÇÃO:";
	//QUERY DAS OF
...
<tr>
<td>Número O.F.:</td>
<td><input type="text" readonly="readonly" style="font-size: 10pt; height: 16px; width:60px;" name="codigo_of" value="<?php echo $row['COD_OF'] ?>" id="codigo_of"/></td>
</tr>
<tr>
<td>Pedido:</td>
<td><input type="text" readonly="readonly" style="font-size: 10pt; height: 16px; width:60px;" name="pedido" value="<?php echo $row['PED_ORIGINAL'] ?>" id="pedido"/></td>
</tr>
<tr>
<td>Prazo:</td>
<td><input type="text" readonly="readonly" style="font-size: 10pt; height: 16px; width:90px;" value="<?php echo $row['PRAZO_OF'] ?>"/></td>
</tr>
<tr>
<td>Cliente:</td>
<td><input type="text" readonly="readonly" style="font-size: 10pt; height: 16px; width:500px;" value="<?php echo $row['CLIENTE'] ?>"/></td>
</tr>
</table>
...
<?php
echo '<br><br>Cadastre os lotes da O.F.: '.$row['COD_OF'].'<br>';
